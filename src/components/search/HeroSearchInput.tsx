          ...
          {results.length === 0 ? (
            ...
            results.map((r) => (
              <a
                ...
                href={r.href}
                className={cn(
                  "block px-3 py-2.5 text-sm "block px-3 py-2.5 text-sm hover:bg-primary hover:text-white transition-colors cursor-pointer border-b last:border-b-0 border-border/50" transition-colors cursor-pointer border-b last:border-b-0 border-border/50"
                )}
